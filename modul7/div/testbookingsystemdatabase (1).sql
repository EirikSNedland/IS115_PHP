...
--
-- Host: 127.0.0.1
-- Generation Time: 02. Nov, 2023 14:18 PM
...
(6, 1, '2023-11-29', '10:00:00', 'DISCORD', 'is115', 1),
...
INSERT INTO `tutors` (`tutor_id`, `fname`, `lname`, `email`, `password`) VALUES
(1, 'Cookie', 'Monster', 'cookie@monster.og', 'Test123'),
(2, 'Scrooge', 'McDuck', 'Scrooge@mnybin.ab', 'HolyCoin');
...
--
ALTER TABLE `timeslots`
  MODIFY `timeslot_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
